...
__device__ void store(GridCellsSoA grid_cell_array, int j, float mean_x_vel, float mean_y_vel, float var_x_vel,
                      float var_y_vel, float covar_xy_vel)
{
    grid_cell_array.mean_x_vel[j] = mean_x_vel;
    grid_cell_array.mean_y_vel[j] = mean_y_vel;
    grid_cell_array.var_x_vel[j] = var_x_vel;
    grid_cell_array.var_y_vel[j] = var_y_vel;
    grid_cell_array.covar_xy_vel[j] = covar_xy_vel;
}
