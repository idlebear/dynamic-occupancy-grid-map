...
__device__ void normalize_weights(float* __restrict__ weight_array, int start_idx, int end_idx, float occ_pred,
                                  float prev_occ_pred)
{
...
__global__ void gridCellPredictionUpdateKernel(GridCellsSoA grid_cell_array, ParticlesSoA particle_array,
                                               ...
                                               float* __restrict__ born_masses_array, float p_S, float p_B,
                                               int cell_count)
{
